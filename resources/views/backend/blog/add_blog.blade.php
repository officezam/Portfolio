    ...
    <aside class="right-side">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li>Blog</li>
                <li class="active">Register Blog</li>
            </ol>
        </section>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-warning">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <form action="{{route('save_blog')}}" method="post" class="form-horizontal" enctype="multipart/form-data">

                                    {{ csrf_field() }}

                                    <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                                        <label for="twilio_auth_token" class="col-sm-2 control-label">Blog Title</label>
                                        <div class="col-sm-8">
                                            <input id="title" type="text" name="title" class="form-control" placeholder="Enter Blog Title" value="{{$settings->title or old('title')}}">
                                            @if( $errors->has('title'))
                                    ...
                                    <div class="form-group{{ $errors->has('icon') ? ' has-error' : '' }}">
                                        <label for="twilio_auth_token" class="col-sm-2 control-label">Blog Image</label>
                                        <div class="col-sm-8">
                                            <input id="title" type="file" name="icon" class="form-control" placeholder="Choose Image" value="{{$settings->icon or old('icon')}}">
                                            @if( $errors->has('icon'))
                                    ...
                                    <div class="form-group{{ $errors->has('short_desc') ? ' has-error' : '' }}">
                                        <label for="twilio_auth_token" class="col-sm-2 control-label">Blog  Short Description</label>
                                        <div class="col-sm-8">
                                            <textarea  class="form-control" placeholder="Enter Blog Short Description" name="short_desc" rows="3">{{$settings->short_desc or old('short_desc')}}</textarea>
                                        ...
                                        <div class='col-lg-12'>
                                            ...
                                            <div class='box well well-sm'>
                                                ...
                                                <div class='box-body pad'>
                                                        <textarea class="textarea editor-cls" style="height: 400px;" name="description" placeholder="Write Blog Detail"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- /.col-->
                                    ...
                                    {{--<div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">--}}
                                        {{--<label for="twilio_auth_token" class="col-sm-2 control-label">Blog Description</label>--}}
                                        {{--<div class="col-sm-12">--}}
                                            {{--<div class="row">--}}

                ...
                <div class="col-lg-12">
                    <div class="panel panel-warning">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <form action="{{route('update_blog')}}" method="post" class="form-horizontal" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    <input type="hidden" name="icon_old" value="{{$blog->icon}}">
                                    <input type="hidden" name="id" value="{{$blog->id}}">
                                    <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                                        <label for="twilio_auth_token" class="col-sm-2 control-label">Blog Title</label>
                                        <div class="col-sm-8">
                                            <input id="title" type="text" name="title" class="form-control" placeholder="Enter Blog Title" value="{{$blog->title or old('title')}}">
                                            @if( $errors->has('title'))
                                    ...
                                    <div class="form-group{{ $errors->has('icon') ? ' has-error' : '' }}">
                                        <label for="twilio_auth_token" class="col-sm-2 control-label">New Blog Image</label>
                                        <div class="col-sm-8">
                                            <input id="title" type="file" name="icon" class="form-control" placeholder="Choose Image" value="{{$blog->icon or old('icon')}}">
                                            @if( $errors->has('icon'))
                                    ...
                                    <div class="form-group{{ $errors->has('short_desc') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-sm-8">
                                            <textarea class="form-control" placeholder="Enter Blog Short Description" name="short_desc" rows="3">{{$blog->short_desc or old('short_desc')}}</textarea>

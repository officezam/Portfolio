    ...
    <aside class="right-side">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Manage All Blog</li>
            </ol>
        </section>
                            ...
                            <div class="panel-title pull-right">
                                <div class="caption">
                                    <a href="{{route('add-blog')}}">
                                        <button class="btn btn-success pull-right">Add Blog</button>
                                    </a>
                                </div>
                            </div>
                        </div>
                            ...
                            <table class="table table-striped table-responsive" id="table1">
                                ...
                                @foreach ( $Date as $key => $value )
                                    <tr class="gradeX">
                                        ...
                                        <td>
                                        <img src="{{ asset('blog/fullsize/'.$value->icon) }}" style="width:20%">
                                        </td>
                                        <td>
                                         <a href="{{ url('/backend/blog/' . $value->id . '/edit') }}">
                                                <i class="ace-icon fa fa-pencil fa-2x icon-only"></i>
                                            </a> |
                                            <a href="{{ url('/backend/blog/' . $value->id . '/delete') }}">

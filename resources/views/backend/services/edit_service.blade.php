                            ...
                            <div class="row">
                                <form action="{{route('update_service')}}" method="post" class="form-horizontal" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group{{ $errors->has('short_desc') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-sm-8">
                                            <textarea style="height: 300px" class="form-control" placeholder="Enter Service Short Description" name="short_desc" rows="3">{{$service->short_desc or old('short_desc')}}</textarea>
                                        ...
                                        <div class='col-lg-12'>
                                            ...
                                            <div class='box well well-sm'>
                                                ...
                                                <div class='box-body pad'>
                                                        <textarea class="textarea editor-cls" name="description" placeholder="Write Service Detail">{{$service->short_desc or old('short_desc')}}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- /.col-->

    ...
    <aside class="right-side">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li>Portfolio</li>
                <li class="active">Register Portfolio</li>
            </ol>
        </section>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-warning">
                        <div class="panel-heading">
                            <h3 class="panel-title">Save Portfolio</h3>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <form action="{{route('save_portfolio')}}" method="post" class="form-horizontal" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-sm-8">
                                            <input id="title" type="text" name="title" class="form-control" placeholder="Enter Portfolio Title" value="{{$settings->title or old('title')}}">
                                            @if( $errors->has('title'))
                                    ...
                                    <div class="form-group{{ $errors->has('icon') ? ' has-error' : '' }}">
                                        <label for="twilio_auth_token" class="col-sm-2 control-label">Portfolio Image</label>
                                        <div class="col-sm-8">
